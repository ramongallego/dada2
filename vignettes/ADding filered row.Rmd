...
until.filter %>% 
  ...
  pull(tracking) %>% 
  map(~.x %>% filter(derepF ==1))

```

Not sure if this is working correctly - I would have expected some consistency between what we find in the fwd and what we find in the Rev